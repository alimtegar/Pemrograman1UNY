...
public class ProcessName {
    ...
    public static String processName(String name) {
        ...
        // Mengambil nama depan (karakter dari index awal (0) sampai indeks spasi)
        String firstName = name.substring(0, iSpace),               
        
        // Mengambil nama belakang ( karakter dari index spasi sampai index terakhir (yg didapat dari name.length())
